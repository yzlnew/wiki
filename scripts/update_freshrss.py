...
PRIMARY_INTEREST_RULES: list[tuple[str, int, tuple[str, ...]]] = [
    (
        "agent-workflows",
        34,
        (
...
STYLE_RULES: list[tuple[str, int, tuple[str, ...]]] = [
    (
        "operational-depth",
        16,
        (
...
SOURCE_BOOST_RULES: list[tuple[str, int, tuple[str, ...]]] = [
    (
        "high-signal-source",
        12,
        (
...
WEAK_SIGNAL_RULES: list[tuple[str, int, tuple[str, ...]]] = [
    (
...
DOWNRANK_RULES: list[tuple[str, int, tuple[str, ...]]] = [
    (
        "generic-ai-news",
        -18,
        (
